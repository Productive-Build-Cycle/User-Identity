...
public class GetRolesHavingClaimAsyncTests
{
    ...
    public async Task GetRolesHavingClaimAsync_ShouldReturnOnlyRolesMatchingClaimTypeAndValue()
    {
        ...
        context.RoleClaims.AddRange(
            new IdentityRoleClaim<Guid> { RoleId = roleMatch.Id, ClaimType = "perm", ClaimValue = "x" },
            new IdentityRoleClaim<Guid> { RoleId = roleWrongValue.Id, ClaimType = "perm", ClaimValue = "y" },
            new IdentityRoleClaim<Guid> { RoleId = roleWrongType.Id, ClaimType = "other", ClaimValue = "x" }
        );
