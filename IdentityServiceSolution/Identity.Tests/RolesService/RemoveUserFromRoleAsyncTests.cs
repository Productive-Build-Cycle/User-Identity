...
public class RemoveUserFromRoleAsyncTests
{
    private readonly Mock<UserManager<ApplicationUser>> _userManagerMock;
    private readonly Mock<RoleManager<ApplicationRole>> _roleManagerMock;
    private readonly RolesService _sut;

    public RemoveUserFromRoleAsyncTests()
    {
    ...
    [Fact]
    public async Task RemoveUserFromRoleAsync_WhenUserNotFound_ShouldThrowKeyNotFoundException()
    {
        // Arrange
    ...
    public async Task RemoveUserFromRoleAsync_WhenUserExists_ShouldSucceed()
    {
        ...
        _userManagerMock
            .Setup(x => x.RemoveFromRoleAsync(user, request.RoleName))
